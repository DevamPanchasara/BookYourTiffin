			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="card-header">
								...
								<div class="col-1" style="float:right"><a href="addCity"><button type="button" class="btn btn-primary">Add</button></a></div>
								
								<h4 class="mb-0 mt-2 col-3">View City</h4>	
											...
											<tbody>
												<c:forEach items="${CityList}" var="p" varStatus="j">
													<tr>
														...
														<td><a href="editCity?id=${p.id}"> <i class="mdi mdi-pencil-box"
																style="font-size: 20px; margin-left: 15px;"></i>
														</a><a href="deleteCity?id=${p.id}"><i class="mdi mdi-delete"
