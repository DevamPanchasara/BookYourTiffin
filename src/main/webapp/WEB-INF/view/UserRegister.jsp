						...
						<div class="header-container row">
							<div class="logo">
								<a href="/userRegister" title="index">
									<div>
										<img  src="<%=request.getContextPath()%>/userResources/images/loginlogo.png"  alt="logo" style="height: 100px; width: 170px;">
									...
									<div class="form-list">
										...
										<div class="input-box">
											...
											<f:select name="billing_address_id"
												...
												<option selected="selected" value="null">Select Gender</option>
												<option value="Male" >Male</option>
												<option value="Female">Female</option>
										
											</f:select>
											<span style="color: red;" id="genderErrDivId"></span>
										</div>
										...
										<div class="input-box">
											...
											<f:input id="username" name="loginvo.username" type="text"
												...
												<span style="color: red;" id="emailErrDivId"></span>
										</div>
										...
										<div class="input-box">
											...
											<f:input id="psw1" type="password" class="input-text"
												...
												<span style="color: red;" id="pswErrDivId"></span>
										</div>
										...
										<div class="input-box">
											<label type="password">Enter Your Confirm Password<em
												...
												<span style="color: red;" id="pswErrDivId1"></span>
										</div>
