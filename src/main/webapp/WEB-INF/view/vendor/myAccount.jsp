...
<body class="sidebar-light">
						...
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<f:form class="cmxform" onsubmit="return validateEditProfile()"
										id="commentForm" method="post" action="saveVendor"
										modelAttribute="vendorVO">
										<fieldset>
											<div class="form-group ">
												<label for="range-from">Name</label>
												<f:input id="fullName" class="form-control"
													name="range-from" path="fullName" type="text" />
											</div>

											<div class="form-group ">
												<label for="range-from">Username</label>
												<f:input id="username" class="form-control"
													name="range-from" path="loginvo.username" type="text" readonly="true" />
											</div>

											<div class="form-group ">
												<label for="range-from">Contect Number</label>
												<f:input id="contactno" class="form-control"
											...
											<div class="form-group ">
												...
												<f:input id="address" class="form-control"
	...
	<script
		src="<%=request.getContextPath()%>/vendorResources/js/custom/EditProfile.js"></script>
