			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="card-header">
									<div class="col-1" style="float:right"><a href="addPackage"><button type="button" class="btn btn-primary">Add</button></a></div>
								
								<h4 class="mb-0 mt-2 col-3">View Package</h4>	
								</div>
						<div class="card-body">
											...
											<tbody>
												...
												<c:forEach items="${packageList}" var="p" varStatus="j">
													<tr>
														...
														<td>${p.packageRangeFrom}</td>
														<td>${p.packageRangeTo}</td>
														<td>${p.percentage}</td>
														<td>${p.packageDuration}</td>

														<td><a href="editPackage?id=${p.id}"> <i class="mdi mdi-pencil-box"
																style="font-size: 20px; margin-left: 15px;"></i>
														</a><a href="deletePackage?id=${p.id}"><i class="mdi mdi-delete"
