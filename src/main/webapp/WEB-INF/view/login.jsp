						...
						<div class="header-container row">
							<div class="logo">
								<a href="/login" title="index">
									<div>
										<img
											src="<%=request.getContextPath()%>/userResources/images/loginlogo.png"
											alt="logo" style="height: 100px; width: 170px;">
									</div>
								</a>
							</div>
						</div>
									...
									<ul class="form-list">
										<div class="input-box">
											<input type="text" placeholder="Enter Email Id*"
												...
												style="color: red;" id="userErrDivId"></span>
										</div>
										</br>
										<div class="input-box">
											<input type="password" placeholder="Enter Password*"
												class="input-text" name="password" id="password"> <span
												style="color: red;" id="passwordErrDivId"></span>
										</div>
										</br>
										<a href="forgotmyPassword" class="forgot-word"
